	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<div class="row" style="margin:7px">
				...
				<input type="checkbox" <?php echo isset($arr["hoten"])&&$arr["gioitinh"]==1?"checked":""; ?> name="gioitinh" id="gioitinh"><label for="gioitinh">Nữ</label>
				</div>
			</div>			
			<!-- end row -->
			...
			<div class="row" style="margin:7px">
				...
				<div class="col-md-10">
					<input type="text" name="mota" class="form-control" required value="<?php echo isset($arr["diachi"])?$arr["diachi"]:""; ?>">
				</div>
			</div>		
			<!-- end row -->
			<!-- row -->
