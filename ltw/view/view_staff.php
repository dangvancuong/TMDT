	...
	<div class="panel panel-primary"> 
		...
		<div class="panel-body">
			...
			<tr>
				...
				<td style="text-align:center">
					<a class="btn-sua" href="index.php?controller=add_edit_staff&act=edit&id=<?php echo $value["idnv"]; ?>">Sửa</a>&nbsp;
					<a href="index.php?controller=staff&act=delete&id=<?php echo $value["idnv"]; ?>" onclick="return window.confirm('Are you sure?');">Xóa</a>&nbsp;
				</td>
			</tr>
			<?php } ?>
			</table>
